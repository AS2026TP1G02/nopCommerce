...
public partial class PriceCalculationService : IPriceCalculationService
{
    ...
    protected virtual async Task<decimal?> GetPriceListPriceAsync(Product product, Customer customer, decimal basePrice)
    {
        ...
        var priceLists = await _priceListService.GetAllPriceListsAsync(customerRoleIds: customerRoleIds, customerIds: [customer.Id], isActive: true, pageSize: int.MaxValue);
