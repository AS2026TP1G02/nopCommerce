...
public partial interface IPriceListService
{
    ...
    /// </returns>
    Task<IPagedList<PriceList>> GetAllPriceListsAsync(int[] customerRoleIds = null, int[] customerIds = null, bool? isActive = null,
    ...
    /// </returns>
    Task<PriceList> GetPriceListByIdAsync(int priceList);
