...
public partial class PriceListModelFactory : IPriceListModelFactory
{
    ...
    public virtual async Task<PriceListListModel> PreparePriceListListModelAsync(PriceListSearchModel searchModel)
    {
        ...
        //get price lists
        var priceLists = await _priceListService.GetAllPriceListsAsync(customerRoleIds: searchModel.SelectedCustomerRoleIds.ToArray(),
    ...
    /// </returns>
    public virtual async Task<AddCustomerToPriceListSearchModel> PrepareAddCustomerToPriceListSearchModelAsync(AddCustomerToPriceListSearchModel searchModel)
    {
        ArgumentNullException.ThrowIfNull(searchModel);
